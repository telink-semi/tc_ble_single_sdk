...
#define PRX_CHANNEL                  7

#if(FAST_CALIBRATION_ENABLE && MCU_CORE_TYPE != MCU_CORE_825x)
...
//////////////////////////// 2P4G stack Initialization  Begin //////////////////////////////////
    ...
    TPLL_SetHpmcCalVal(hpmc[PRX_CHANNEL]);
...
#if(MCU_CORE_TYPE == MCU_CORE_TC321X)
    rf_irq_enable(FLD_RF_IRQ_TX | FLD_RF_IRQ_TX_DS | FLD_RF_IRQ_RX_DR | FLD_RF_IRQ_HIT_SYNC | FLD_RF_IRQ_HEADER_DONE | FLD_RF_IRQ_INVALID_PID);
#elif(MCU_CORE_TYPE == MCU_CORE_825x || MCU_CORE_TYPE == MCU_CORE_827x)
    rf_irq_enable(FLD_RF_IRQ_TX | FLD_RF_IRQ_TX_DS | FLD_RF_IRQ_RX_DR | FLD_RF_IRQ_INVALID_PID);
#endif
    irq_enable();
