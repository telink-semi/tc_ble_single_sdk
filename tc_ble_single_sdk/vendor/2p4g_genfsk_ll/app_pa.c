...
#if (GENFSK_LL_MODE == GENFSK_PA)
#if(MCU_CORE_TYPE == MCU_CORE_TC321X)
#define RF_TX_DONE_PIN                  GPIO_PC2
#define RF_RX_DONE_PIN                  GPIO_PC3
#define RF_RX_TIMEOUT_PIN               GPIO_PC6
#define RF_FIRST_TIMEOUT_PIN            GPIO_PC7
#define TIME_DEBUG_PIN                  GPIO_PD4
#elif(MCU_CORE_TYPE == MCU_CORE_825x || MCU_CORE_TYPE == MCU_CORE_827x)
#define RF_TX_DONE_PIN                  GPIO_PB2
#define RF_RX_DONE_PIN                  GPIO_PB3
#define RF_RX_TIMEOUT_PIN               GPIO_PB4
#define RF_FIRST_TIMEOUT_PIN            GPIO_PB5
#define TIME_DEBUG_PIN                  GPIO_PA4
#endif
...
volatile unsigned int irq_cnt_rx_first_timeout = 0;
volatile unsigned char rx_first_timeout_flag   = 0;
...
volatile unsigned int  irq_cnt_rx_timeout      = 0;
...
//////////////////////////////////// User 2P4G application /////////////////////////////////////
      ...
      gen_fsk_srx_start(clock_time()+50*16, 500); //RX first timeout is disabled and the transceiver won't exit the RX state until a packet arrives
#elif (FUNC_TEST == FUNC_STX2RX_TEST)
      gpio_write(TIME_DEBUG_PIN,1);
      gen_fsk_stx2rx_start(tx_buffer, clock_time()+50*16, 250);
#elif (FUNC_TEST == FUNC_SRX2TX_TEST)
      gpio_write(TIME_DEBUG_PIN,1);
      gen_fsk_srx2tx_start(tx_buffer, clock_time()+50*16, 500);
#endif
////////////////////////////////////////////////////////////////////////////////////////////////
}
...
void func_srx_test(void)
{
    ...
    if (rx_flag) {
        ...
        gpio_write(TIME_DEBUG_PIN,0);
        //start the SRX
        gen_fsk_srx_start(clock_time()+50*16, 500);
        gpio_write(TIME_DEBUG_PIN,1);
    }
