...
#define GENFSK_RX                        1
#define GENFSK_SRX                       2
#define GENFSK_SRX2TX                    3
#define GENFSK_STX                       4
#define GENFSK_STX_DPL_PKT               5
#define GENFSK_STX2RX                    6
#define GENFSK_TX                        7

#define GENFSK_LL_MODE                   GENFSK_RX
