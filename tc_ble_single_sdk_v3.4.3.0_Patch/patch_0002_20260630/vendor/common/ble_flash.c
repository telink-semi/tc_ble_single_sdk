...
void blc_readFlashSize_autoConfigCustomFlashSector(void)
{
    ...
    if(blc_flash_capacity == FLASH_SIZE_64K)
    {
        tlkapi_printf(APP_FLASH_INIT_LOG_EN, "[FLASH][INI] 64K Flash, Only for 2.4G\n");
    }
#else
    if (0){}
#endif

#if (FLASH_GD25LD10C_SUPPORT_EN || FLASH_GD25LD10E_SUPPORT_EN || FLASH_ZB25WD10B_SUPPORT_EN)
    else if(blc_flash_capacity == FLASH_SIZE_128K)
    {
        tlkapi_printf(APP_FLASH_INIT_LOG_EN, "[FLASH][INI] 128K Flash, Only for 2.4G\n");
    }
#endif
...
#endif
#if (FLASH_ZB25WD80B_SUPPORT_EN || FLASH_GD25LD80C_SUPPORT_EN || FLASH_GD25LD80E_SUPPORT_EN || FLASH_P25Q80U_SUPPORT_EN || \
	FLASH_P25Q80SU_SUPPORT_EN || FLASH_TH25Q80U_SUPPORT_EN || FLASH_ZB25WD80C_SUPPORT_EN)		//1M
		...
		flash_sector_master_pairing = FLASH_ADR_MASTER_PAIRING_2M;
