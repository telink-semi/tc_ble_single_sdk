...
//	gpio_set_func(GPIO_PD2 | GPIO_PD7 | GPIO_PD5,AS_GPIO);
//	gpio_set_output_en(GPIO_PD2 | GPIO_PD7 | GPIO_PD5, 1);        //enable output
//	gpio_set_input_en(GPIO_PD2 | GPIO_PD7 | GPIO_PD5 ,0);
//
//	gpio_set_func(GPIO_PB1 | GPIO_PB3| GPIO_PB4| GPIO_PB6| GPIO_PB7,AS_GPIO);
//    gpio_set_output_en(GPIO_PB1 | GPIO_PB3| GPIO_PB4| GPIO_PB6| GPIO_PB7, 1);        //enable output
//    gpio_set_input_en(GPIO_PB1 | GPIO_PB3| GPIO_PB4| GPIO_PB6| GPIO_PB7 ,0);
